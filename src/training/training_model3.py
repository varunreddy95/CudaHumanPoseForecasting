...
if True:
    ...
    training_loss, _ = training_heatmap(model=model, optimizer=optimizer, scheduler=scheduler, criterion=criterion,
                                train_loader=train_loader, valid_loader=valid_loader, logdir="Heatmap-Statespace-128-128-MSE-30-09", cfg=cfg)
...
if False:
    ...
    training_loss, _ = training_heatmap(model=model, optimizer=optimizer, scheduler=scheduler, criterion=criterion,
                                        ...
                                        logdir="Heatmap-Autoregressive-128-128-MSE-training-heatmap", cfg=cfg)
